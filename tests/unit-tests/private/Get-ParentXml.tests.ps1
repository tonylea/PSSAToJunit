Describe "Get-ParentXml" {
    ...
    Context "Parameters" {
        ...
        It "Has a mandatory 'TestRunName' parameter" {
            $Function | Should -HaveParameter TestRunName -Type System.String -Mandatory
        }
    }
}
